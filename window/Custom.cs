...
namespace APKStudio.Window
{
    ...
    public partial class Custom : UserControl
    {
        ...
        private void ctlSkin_Paint(object sender, PaintEventArgs e)
        {
            ...
            //위
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(0, 0, _upCornerW, _upH), 0, 0, _upCornerW, _upH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(_upCornerW, 0, this.Width - 2 * _upCornerW, _upH), _upCornerW, 0, _layoutW - 2 * _upCornerW, _upH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(this.Width - _upCornerW, 0, _upCornerW, _upH), _layoutW - _upCornerW, 0, _upCornerW, _upH, GraphicsUnit.Pixel);

            //중간
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(0, _upH, _upCornerW, this.Height - _upH - _downH), 0, _upH, _upCornerW, _barH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(_upCornerW, _upH, this.Width - 2 * _upCornerW, this.Height - _upH - _downH), _upCornerW, _upH, _layoutW - 2 * _upCornerW, _barH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(this.Width - _upCornerW, _upH, _upCornerW, this.Height - _upH - _downH), _layoutW - _upCornerW, _upH, _upCornerW, _barH, GraphicsUnit.Pixel);

            //아래
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(0, this.Height - _downH, _upCornerW, _downH), 0, _layoutW - _downH, _upCornerW, _downH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(_upCornerW, this.Height - _downH, this.Width - 2 * _upCornerW, _downH), _upCornerW, _layoutW - _downH, _layoutW - 2 * _upCornerW, _downH, GraphicsUnit.Pixel);
            buff.Graphics.DrawImage(WindowBorder.Image, new Rectangle(this.Width - _upCornerW, this.Height - _downH, _upCornerW, _downH), _layoutW - _upCornerW, _layoutW - _downH, _upCornerW, _downH, GraphicsUnit.Pixel);
            ...
            {   // 마우스 커서가 버튼 구간에 있음
                ...
                {//종료 버튼 구간에 있음
                    ...
                    if (_isClicked)
                        buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW + _btMaxW, 0, _btExitW, _btH), _btMinW + _btMaxW, 2 * _btH, _btExitW, _btH, GraphicsUnit.Pixel);
                    else
                        buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW + _btMaxW, 0, _btExitW, _btH), _btMinW + _btMaxW, 1 * _btH, _btExitW, _btH, GraphicsUnit.Pixel);
                    ...
                    if (!FixedSingle)
                    {
                        if (Stretch)
                            if (_isMaxed)
                                buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), 0, 4 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                            else
                                buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMinW, 0, _btMaxW, _btH, GraphicsUnit.Pixel);
                        else
                            buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMinW, 3 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);

                        buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL, 0, _btMinW, _btH), 0, 0, _btMinW, _btH, GraphicsUnit.Pixel);
                    }
                }
                ...
                {//최대화 버튼 구간에 있음
                    ...
                    if (!FixedSingle)
                    {
                        ...
                        if (Stretch)
                        {
                            if (_isClicked)
                                if (_isMaxed)
                                    buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMaxW * 2, 4 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                                else
                                    buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMinW, 2 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                            else
                                if (_isMaxed)
                                    buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMaxW, 4 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                                else
                                    buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMinW, 1 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                        }
                        else
                            buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW, 0, _btMaxW, _btH), _btMinW, 3 * _btH, _btMaxW, _btH, GraphicsUnit.Pixel);
                    ...
                    buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW + _btMaxW, 0, _btExitW, _btH), _btMinW + _btMaxW, 0, _btExitW, _btH, GraphicsUnit.Pixel);
                ...
                {//최소화 구간에있음
                    if (!FixedSingle)
                    {
                        ...
                        if (_isClicked)
                            buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL, 0, _btMinW, _btH), 0, 2 * _btH, _btMinW, _btH, GraphicsUnit.Pixel);
                        else
                            buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL, 0, _btMinW, _btH), 0, 1 * _btH, _btMinW, _btH, GraphicsUnit.Pixel);
            ...
            if (FixedSingle)
                buff.Graphics.DrawImage(WindowButtons.Image, new Rectangle(Width - _btL + _btMinW + _btMaxW - 2, 0, 2, _btH), 0, 0, 2, _btH, GraphicsUnit.Pixel);
